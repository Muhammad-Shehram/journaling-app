...
# The after_create callback already created the default "Journal" — keep it
journal_default = alex.journals.find_by!(is_default: true)

journal_default.journal_entries.create!(
  title: "First Entry",
  entry_date: Date.new(2026, 4, 22),
  content: "Starting fresh. This is the default journal — the place things land when I'm not sure where else to put them. Stream of consciousness, notes to self, the half-formed thoughts that don't belong anywhere specific yet.\n\nLet's see what this becomes."
)

journal_default.journal_entries.create!(
  title: "Clearing My Head",
  entry_date: Date.new(2026, 4, 16),
  content: "Sometimes I open this just to dump whatever is taking up space. No theme, no structure. Today it's a mix of things I need to do, a conversation I keep replaying, and a vague feeling that I'm not spending my time on the right things.\n\nWriting it out doesn't solve any of it. But it makes it feel less like a tangled knot and more like a list. Lists are manageable."
)
